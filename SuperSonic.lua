...
function lib:Window(text, preset, closebind)
    ...
    Title.Text = text
    Title.TextColor3 = Color3.fromRGB(136,8 ,8 )
    ...
    function lib:Notification(texttitle, textdesc, textbtn)
        ...
        OkayBtnTitle.TextColor3 = Color3.fromRGB(136, 8, 8)
        ...
        NotificationTitle.TextColor3 = Color3.fromRGB(136, 8, 8)
        ...
        NotificationDesc.TextColor3 = Color3.fromRGB(136, 8, 8)
    ...
    function tabhold:Tab(text)
        ...
        if fs == false then
            ...
            TabTitle.TextColor3 = Color3.fromRGB(136, 8, 8)
            Tab.Visible = true
        end
                ...
                for i, v in next, TabHold:GetChildren() do
                    if v.Name == "TabBtn" then
                        ...
                        TweenService:Create(
                            TabTitle,
                            TweenInfo.new(.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
                            {TextColor3 = Color3.fromRGB(136, 8, 8)}
                        ):Play()
                    end
                end
            end
        ...
        function tabcontent:Button(text, callback)
            ...
            ButtonTitle.TextColor3 = Color3.fromRGB(136, 8, 8)
        ...
        function tabcontent:Toggle(text,default, callback)
            ...
            ToggleTitle.TextColor3 = Color3.fromRGB(136, 8, 8)
    ...
    SliderTitle.TextColor3 = Color3.fromRGB(136, 8, 8)
    ...
    SliderValue.TextColor3 = Color3.fromRGB(136, 8, 8)
    ...
    return Slider
        ...
        function tabcontent:Dropdown(text, list, callback)
            ...
            DropdownTitle.TextColor3 = Color3.fromRGB(136, 8, 8)
            ...
            for i, v in next, list do
                ...
                Item.Text = v
                Item.TextColor3 = Color3.fromRGB(136, 8, 8)
        ...
        function tabcontent:Colorpicker(text, preset, callback)
            ...
            ColorpickerTitle.TextColor3 = Color3.fromRGB(136, 8, 8)
            ...
            ConfirmBtnTitle.TextColor3 = Color3.fromRGB(136, 8, 8)
            ...
            RainbowToggleTitle.TextColor3 = Color3.fromRGB(136, 8, 8)
        ...
        function tabcontent:Label(text)
            ...
            LabelTitle.TextColor3 = Color3.fromRGB(136, 8, 8)
        ...
        function tabcontent:Textbox(text, disapper, callback)
            ...
            TextboxTitle.TextColor3 = Color3.fromRGB(136, 8, 8)
            ...
            TextBox.Text = ""
            TextBox.TextColor3 = Color3.fromRGB(136, 8, 8)
        ...
        function tabcontent:Bind(text, keypreset, callback)
            ...
            BindTitle.Text = text
            BindTitle.TextColor3 = Color3.fromRGB(136, 8, 8)
            ...
            BindText.Text = Key
            BindText.TextColor3 = Color3.fromRGB(136, 8, 8)
